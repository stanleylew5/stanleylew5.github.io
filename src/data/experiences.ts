...
const experiences = [
  ...
  },
  {
    ...
    contributions: [
      ...
      "- Increased ACM programs membership by over 150%, driving engagement and participation through effective outreach and project-based learning opportunities for 100+ members quarterly.",
      "- Enforced CI/CD workflows across multiple Spark teams with GitHub Actions to ensure consistent formatting, linting, and successful builds across all team contributions.",
    ],
  },
  {
    photo: dv,
    ...
    city: "Riverside, California",
    contributions: [
      "- Led a committee of 10+ web developers for the creation of the official Designverse 2025 website",
      "- Developed 10+ schemas with Zod to handle user input for form validation within all Hackathon Portal forms",
      "- Led Python Discord Bot & Intro to Frontend Workshops at UCR Hackathons",
    ],
  },
  {
    photo: tkh,
